      ...
      <div className="flex flex-wrap items-center gap-2">
          ...
          {options.map((o) => (
            <button
              ...
              className={`px-3 py-1.5 text-xs font-semibold transition ${
                value === o.v
                  ? 'bg-[#eaf6f3] text-[#056559]'
                  : 'bg-white text-slate-500 hover:bg-slate-50'
              } ${o.v !== 'yes' ? 'border-l border-slate-200' : ''}`}
            >
              {o.label}
            </button>
          ))}
        ...
        {value === 'yes' && onAgeChange && (
          <input
            ...
            className="w-36 rounded-full border border-slate-200 px-3 py-1.5 text-xs text-slate-900 outline-none focus:border-[#056559]"
          />
        )}
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 py-8">
      <div className="mx-auto w-full max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <h1 className="text-xl font-bold text-[#056559]">Puberty Screening</h1>
        ...
        {!formOpen && !hasHistory && (
          <div className="mb-6 flex flex-col gap-4 rounded-2xl bg-white p-6 border border-slate-200 shadow-2xs">
            <div className="flex items-center gap-2">
              <Brain size={20} className="text-[#056559]" />
            ...
            <ul className="flex flex-col gap-2 text-sm text-slate-600">
              <li className="flex gap-2">
                <span className="text-[#056559]">•</span>
                <span>
                  <span className="font-medium text-slate-900">You never need to examine {child.name}.</span>{' '}
              ...
              <li className="flex gap-2">
                <span className="text-[#056559]">•</span>
                <span>
                  <span className="font-medium text-slate-900">"Not sure" is a real answer.</span> Saying so
            ...
            <button
              ...
              className="rounded-full bg-[#056559] py-3 text-sm font-semibold text-white transition hover:bg-[#03443c]"
            >
              Start screening
            </button>
          </div>
        ...
        {!formOpen && hasHistory && (
          <button
            type="button"
            onClick={() => setFormOpen(true)}
            className="mb-6 w-full rounded-full bg-[#056559] py-3 text-sm font-semibold text-white transition hover:bg-[#03443c]"
          >
            Screen again
          </button>
        )}
        ...
        {formOpen && (
          <div className="flex flex-col gap-6">
            ...
            {/* Everyday changes */}
            <div className="flex flex-col gap-3 rounded-2xl bg-white p-5 border border-slate-200 shadow-2xs">
              <div className="mb-1 flex items-start justify-between gap-3">
                <div>
                  <h2 className="text-base font-semibold text-slate-900">Everyday changes</h2>
            ...
            <div className="flex flex-col gap-3 rounded-2xl bg-white p-5 border border-slate-200 shadow-2xs">
              <div>
                <h2 className="text-base font-semibold text-slate-900">Signs of physical development</h2>
            ...
            <div className="flex flex-col gap-3 rounded-2xl bg-white p-5 border border-slate-200 shadow-2xs">
              ...
              <div>
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm text-slate-900 outline-none focus:border-[#056559]"
                />
                <p className="mt-1 text-xs text-slate-500">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-slate-200 px-4 py-2.5 text-sm text-slate-900 outline-none focus:border-[#056559]"
              />
        ...
        {hasHistory && (
          <div className="mt-6 rounded-2xl bg-white p-5 border border-slate-200 shadow-2xs">
